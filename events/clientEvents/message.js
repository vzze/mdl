...
module.exports = {
    async run(client, message) {
        ...
        if(!message.content.startsWith(prefix)) {
            ...
            addXP(message.author.id, getRandomXP(3, 7), message.author.tag)
            memberaddXP(message.author.id, getRandomXP(10, 25), message.author.tag, message.guild.id).then( async val => {
